...
- [**Venue rating predictor**](https://github.com/mzyrke/venue_popularity): Used Yelp's dataset for venue popularities and successfully predicted the venue popularity for new locations based on city, category, location, and other attributes. The ML model is developed using sklearn, an ensemble regressor combines 4 models mentioned above. In each model the hyperparameters were optimized using gridsearchCV.
